<template>
    <div class="container">
        ...
        <div class="p-container">
            <p>
                <strong> Faroptic and OptoFitting application</strong> is
                committed to providing quality services to you and this policy
                outlines our ongoing obligations to you in respect of how we
            ...
            <p>
                ...
                Commissioner at
                <a href="http://www.aoic.gov.au/"> www.aoic.gov.au</a>
            </p>
            ...
            <p>
                ...
                collect including names, addresses, email addresses, phone
                number.
            </p>
            <p>
                his Personal Information is obtained in many ways including
                Name, email address, Device ID , Phone number and via our
                application and also our website
                <a href="https://sites.google.com/view/faroptic/home,"
                    >https://sites.google.com/view/faroptic/home</a
                >
                , from cookies and from third parties.
            </p>
            <p>
                We collect your Personal Information for the primary purpose of
                providing our services to you, providing information to our for
            ...
            <h4>Sensitive information will be used by us only:</h4>
            <ul>
                <li>
                    <small>•</small> For the primary purpose for which it was
                    obtained
                </li>
                <li>
                    <small>•</small> For a secondary purpose that is directly
                    related to the primary purpose
                </li>
                <li>
                    <small>•</small> With your consent; or where required or
                    authorised by law.
                </li>
            </ul>
            <h3>Third Parties</h3>
            ...
            <ul>
                <li>
                    <small>•</small> Third parties where you consent to the use
                    or disclosure; and
                </li>
                <li><small>•</small> Where required or authorised by law.</li>
            </ul>
            ...
            <p>
                <strong>Faroptic</strong> will not charge any fee for your
                access request, but may charge an administrative fee for
